...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.video2.setGeometry(QtCore.QRect(860, 10, 601, 561))
        self.video2.setFrameShape(QtWidgets.QFrame.Box)
        self.video2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.video2.setLineWidth(7)
        self.video2.setText("")
